    ...
    <table>
        <tr>
            <td>
                ...
                <input type="button" value="1" name="{{$index}}"/></label>
                {{$value.option1}}

                {{if $value.option2==""}} 错误{{/if}}
                <label class="btn btn-default">B
                <input type="button" value="2" name="{{$index}}"/></label>
                {{$value.option2}}

                {{if $value.option3!=""}}
                <label class="btn btn-default">C
                <input type="button" name="{{$index}}"/>
                </label>{{$value.option3}}
                {{/if}}

                {{if $value.option4!=""}}
                <label class="btn btn-default">D
                <input type="button" value="4" name="{{$index}}"/>
                </label>{{$value.option4}}
                {{/if}}
